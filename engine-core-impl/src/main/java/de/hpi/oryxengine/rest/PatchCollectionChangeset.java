 ...
 * href="http://tools.ietf.org/html/rfc5789"/>, the update is to be communicated in some kind of changeset. This is
 * implemented here.
 *
 * @param <T> the generic type of items, that are updated in the collection
 */
...
public class PatchCollectionChangeset<T> {
     ...
     * Sets the removals.
     *
     * @param removals the new removals
     */
    @JsonProperty("removals")
...
//        PatchCollectionChangeset<T> returnValue = ServiceFactory.getJsonMapper().readValue(json, WorklistActionWrapper.class);
//        return returnValue;
//    }
}
