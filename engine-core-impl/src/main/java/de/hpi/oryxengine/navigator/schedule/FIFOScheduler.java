...
/**
 * The Class FIFOScheduler.
 * It is a simple FIFO Scheduler so nothing too interesting going on around here.
 */
public class FIFOScheduler implements Scheduler {
    ...
    /**
     * Instantiates a new simple scheduler queue.
     * Thereby instantiating a synchronized linked list.
     */
    FIFOScheduler() {
