...
public interface IdentityService {
     ...
     */
    @Nonnull
    Set<AbstractOrganizationUnit> getOrganizationUnits();
     ...
     */
    @Nonnull
    Set<AbstractPosition> getPositions();
     ...
     */
    @Nonnull
    Set<AbstractParticipant> getParticipants();
     ...
     */
    @Nullable
    AbstractRole getRole(@Nonnull UUID roleId)
    throws ResourceNotAvailableException;
     ...
     */
    @Nullable
    AbstractPosition getPosition(@Nonnull UUID positionId)
    throws ResourceNotAvailableException;
     ...
     */
    @Nullable
    AbstractOrganizationUnit getOrganizationUnit(@Nonnull UUID organizationUnitId)
    throws ResourceNotAvailableException;
     ...
     */
    @Nullable
    AbstractParticipant getParticipant(@Nonnull UUID participantId)
    throws ResourceNotAvailableException;
}
