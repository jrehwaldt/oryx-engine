...
public class BenchmarkDeployer {
    ...
    public static void initializeNodes() throws DefinitionNotFoundException {
        ...
        Task roleATask = createRoleTask("Do stuff", "Do it", form,
            roleA);
        Task roleBTask = createRoleTask("Do stuff", "Do it", form,
            roleB);
        Task roleCTask = createRoleTask("Do stuff", "Do it", form,
            roleC);
        Task roleDTask = createRoleTask("Do stuff", "Do it", form,
            roleD);
        Task roleETask = createRoleTask("Do stuff", "Do it", form,
            roleE);
        ...
        processDefinitionBuilder.setName("Benchmark Process").setDescription("This process has 5 roles, some parallel gateways and user tasks only.");
    }
